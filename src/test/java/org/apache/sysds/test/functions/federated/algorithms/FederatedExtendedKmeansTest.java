...
public class FederatedExtendedKmeansTest extends AutomatedTestBase {

	private final static String TEST_DIR = "functions/federated/";
	private final static String TEST_NAME = "FederatedKmeansTest";
	private final static String TEST_CLASS_DIR = TEST_DIR + FederatedExtendedKmeansTest.class.getSimpleName() + "/";
	...
	public void federatedKmeans2Singlenode() {
		federatedKmeans(ExecMode.SINGLE_NODE, false);
	}

	@Test
	public void federatedKmeans1Singlenode() {
		federatedKmeans(ExecMode.SINGLE_NODE, true);
	}

	@Test
	@Ignore
	public void federatedKmeans2Hybrid() {
		federatedKmeans(ExecMode.HYBRID, false);
	}

	public void federatedKmeans(ExecMode execMode, boolean singleWorker) {
